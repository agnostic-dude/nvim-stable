...
require("nvim-dap-virtual-text").setup({
  ...
  -- DapVirtualTextEnable, DapVirtualTextDisable, DapVirtualTextToggle,
  -- (DapVirtualTextForceRefresh for refreshing when debug adapter did not
  -- notify its termination)
  enabled_commands = true,

  -- highlight changed values with NvimDapVirtualTextChanged, else always
  -- NvimDapVirtualText
  ...
  virt_text_pos = 'eol', -- virtual text position, see :h nvim_buf_set_extmark()
  all_frames = false, -- show virtual text for all stack frames not only current. Only works for debugpy on plugin author's machine.
